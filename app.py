...
RAZORPAY_NOTIFY_SMS = env_flag("RAZORPAY_NOTIFY_SMS", "false")
RAZORPAY_NOTIFY_EMAIL = env_flag("RAZORPAY_NOTIFY_EMAIL", "false")
RAZORPAY_REMINDER_ENABLE = env_flag("RAZORPAY_REMINDER_ENABLE", "false")
